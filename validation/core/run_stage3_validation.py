...
from validation.harnesses.stage3_test_harness import Stage3TestHarness, Metrics
from validation.utilities.performance_profiler import PerformanceMetrics
...
class ValidationRunner:
    ...
    def _generate_reports(self, metrics: Metrics, performance_metrics: PerformanceMetrics) -> bool:
        ...
        try:
            ...
            from validation.utilities.report_generator import JSONReportGenerator, MarkdownReportGenerator, GoNoGoDecisionMaker
